...
class TestProjectViewSet(TestCase):
    def setUp(self):
        ...
        self.admin = get_user_model().objects.create_superuser(
            username="Администратор 1", email="test@gmail.com", password="123"
        )
        self.user = get_user_model().objects.create_user(
            username="Владелец проектов 2", email="test2@gmail.com", password="123"
        )
...
class TestTodoViewSet(APITestCase):
    def setUp(self):
        self.admin = get_user_model().objects.create_superuser(
            username="Администратор 2", email="test@gmail.com", password="123"
        )
        self.user = get_user_model().objects.create_user(
            username="Владелец проектов 2", email="test@gmail.com", password="123"
        )
